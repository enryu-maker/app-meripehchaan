...
export default function Navbar() {
    ...
    const navigation = [
        ...
        { name: 'Login', href: '/login', current: current.pathname === '/login' ? true : false },
        { name: 'Signup', href: '/register', current: current.pathname === '/register' ? true : false },
    ]
    return (
                        ...
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex  items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex flex-shrink-0 items-center">
                                    <img
                                        className="h-12 w-auto ml-10 lg:ml-0"
                                        src={IMAGE.logo}
                                        alt="Your Company"
                                    />
                                </div>
                        ...
                        <div className="space-y-1 px-2 pb-3 pt-2 flex justify-center items-center">
                            {navigation.map((item) => (
                                <Disclosure.Button
                                    ...
                                    href={item.href}
                                    className={classNames(
                                        item.current ? 'bg-gray-900 text-white font-bold' : 'text-gray-400 hover:bg-gray-700 hover:text-white font-medium',
                                        'block rounded-md px-3 py-1 text-base '
                                    )}
                                    aria-current={item.current ? 'page' : undefined}
                                >
                                    {item.name}
